...
const static std::string kChargingLedPath = "/sys/class/leds/chg_red/brightness";
const static std::string kNotificationLedPath = "/sys/class/leds/chg_green/brightness";
